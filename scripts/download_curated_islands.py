...
CURATED = [
    ...
    ("IslandBgNogutsunajima", "nogutsunajima.jpg", "local", "", "Photo: 松山市　まちづくり推進課（野忽那島）"),
    ("IslandBgNuwajima", "nuwajima.jpg", "local", "", "Photo: 松山市　まちづくり推進課（怒和島）"),
    ("IslandBgTsuwajishima", "tsuwajishima.jpg", "local", "", "Photo: 松山市　まちづくり推進課（津和地島）"),
    ...
    ("IslandBgAijima", "aijima.jpg", "local", "", "Photo: 松山市　まちづくり推進課（安居島）"),
